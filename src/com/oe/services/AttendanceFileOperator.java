...
public class AttendanceFileOperator {
	...
	public void readFile() throws IOException, ParseException {
		...
		String excelFilePath = "/opt/workspaces/workspace/OEAttendance/oldOfficeData.xls";
		//String excelFilePath = "/opt/workspaces/workspace/OEAttendance/attendanceNew.xls";
				...
				if (OperationHelper.isRowContainsEmployeeId(nextRow)) { //check row that contains empId
					...
					while (cellIterator.hasNext()) {
						...
						//	day.setDayName(CalenderService.getNameOfDay(CalenderService.convertToDate(formatter.formatCellValue(cell))));
							//day.setDayName(CalenderService.getNameOfDay(CalenderService.convertToDate(formatter.formatCellValue(cell)))+""+CalenderService.convertToDate(formatter.formatCellValue(cell)));
							day.setDayName(CalenderService.getNameOfDay(CalenderService.convertToDate(formatter.formatCellValue(cell))).substring(0, 3)+" "+cell.toString());
						...
						if (cell.getColumnIndex() == wfhColumnNumber) {
							...
							if (cell.getDateCellValue()!=null) {
								...
								day.setWorkFromHomeHours((cell.getNumericCellValue()+""));
							}
							else{
